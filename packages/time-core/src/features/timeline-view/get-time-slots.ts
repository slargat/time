...
/**
 * Generate the time axis for the timeline view. Salvaged verbatim from
 * `@tanstack/time`'s `getTimeSlots` (copied in per the self-contained rule,
 * ADR 0007). Returns slots with locale-formatted labels.
 */
